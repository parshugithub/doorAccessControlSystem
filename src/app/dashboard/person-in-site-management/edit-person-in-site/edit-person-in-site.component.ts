...
@Component({
  selector: 'app-edit-person-in-site',
  templateUrl: './edit-person-in-site.component.html',
  styleUrls: ['./edit-person-in-site.component.scss']
})
export class EditPersonInSiteComponent implements OnInit {
  site = new Site();
  siteid:number;
  schedule=[];
  siteSelect:any;
 ...
 // scheduleMain = new ScheduleMain();
  ...
  constructor( public userService: UserService,public personInSiteService: PersonInSiteService,public siteManagementservice:SitemanagementService,private router: Router,private route: ActivatedRoute,public datepipe: DatePipe,private personService:PersonService,private toaster:ToastrService,private cpService: ColorPickerService) { }
...
this.personInSiteService.getOnlyPersonInSite(personid)
  .subscribe(data => {
...
let personid = this.route.snapshot.params['personid'];
    ...
    this.personInSiteService.updatePersonData(personid,this.person).subscribe(
      (res) => {
