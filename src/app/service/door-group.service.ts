...
export class DoorGroupService {
  ...
  doorGroupPost(id,siteid,doorGroup:DoorGroup): Observable<DoorGroup> {
    ...
    return this.httpClient.post<DoorGroup>(this.apiServer + '/doorgroup/create?custid='+id+'&siteid='+siteid,doorGroup,this.httpOptions)
      .pipe(
  ...
  updateDoorgroupData(doorgroupid, doorGroup): Observable<DoorGroup> {
    return this.httpClient.put<DoorGroup>(this.apiServer + '/doorgroup/update?doorgroupid='+doorgroupid, JSON.stringify(doorGroup), this.httpOptions)
    .pipe(
      catchError(this.errorHandler)
    )
  }
  ...
  getAll(siteid,custid): Observable<DoorGroup[]> {
    console.log("cmg")
    return this.httpClient.get<DoorGroup[]>(this.apiServer + '/doorgroup/getall?siteid='+siteid+'&custid='+custid)
    .pipe(
    catchError(this.errorHandler)
    )
    }
  ...
  getOnlySingleDoorGroup(doorgroupid) :Observable<DoorGroup[]> {
    console.log("sjhfsdk")
    console.log("cmg")
    return this.httpClient.get<DoorGroup[]>(this.apiServer + '/doorgroup/getdoorGroup?doorgroupid='+ doorgroupid)
    .pipe(
      catchError(this.errorHandler)
    )
  }
  ...
  deleteDoorGroup(doorgroupid): Observable<any> {
    return this.httpClient.delete<any>(this.apiServer + '/doorgroup/delete?doorgroupid='+doorgroupid,{responseType: 'text' as 'json' });
    }
